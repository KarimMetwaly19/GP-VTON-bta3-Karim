...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # input/output sizes
        self.parser.add_argument('--batchSize', type=int, default=2, help='input batch size')  #mody
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--PBAFN_warp_checkpoint', type=str,
                                 help='load the pretrained model from the specified location')
        self.parser.add_argument('--PBAFN_gen_checkpoint', type=str, default='/kaggle/input/resunet-low-depth-chechkpoints/flow/PBAFN_gen_epoch_019.pth',
                                 help='load the pretrained model from the specified location')
...
class AlignedDataset(BaseDataset):
    def initialize(self, opt, mode='train'):
        ...
        for line in lines:
            ...
            P_path = os.path.join(self.root, 'train', 'image', p_name)
            C_path = os.path.join(self.root, 'train', 'cloth', c_name)
